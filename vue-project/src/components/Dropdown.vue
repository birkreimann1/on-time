<template>
  <div class="relative inline-block">
    ...
    <button @click="toggleDropdown" class="bg-neutral-800 px-4 py-2 rounded-lg w-full text-neutral-200">
      <div class="flex items-center justify-between gap-2">
        <div>
          {{ translatedSelectedItem }}
        </div>
        <div>
          <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" height="16" width="16" class="fill-white">
            <path
    ...
    <!-- Dropdown Menu -->
    <div v-if="isOpen" class="absolute mt-1 w-full bg-neutral-900 text-neutral-200 shadow-lg rounded-lg z-50">
      <ul>
        <li v-for="(item, index) in availableItems" :key="index" @click="selectItem(item)"
